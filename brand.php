		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" style="color: blue;" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Brand </button>
				</div> <!-- /div-action -->				
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="brandName" maxlength="50" placeholder="Brand Name" name="brandName" autocomplete="off" id="text1" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;"
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		      	<div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editBrandName" maxlength="50" placeholder="Brand Name" name="editBrandName" autocomplete="off" id="text1" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;"
        onpaste="return false;" /><span id="error" style="color: Red; display: none">* Special Characters and Numbers not allowed</span>
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
