		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" style="color: blue;" id="addCategoriesModalBtn" data-target="#addCategoriesModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Categories </button>
				</div> <!-- /div-action -->				
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="categoriesName" maxlength="50" placeholder="Categories Name" name="categoriesName" autocomplete="off" id="text1" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;"
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result">
		      	<div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" id="editCategoriesName" maxlength="50" placeholder="Categories Name" name="editCategoriesName" autocomplete="off" id="text1" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;"
        onpaste="return false;" /><span id="error" style="color: Red; display: none">* Special Characters and Numbers not allowed</span>
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
