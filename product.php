		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" style="color: blue;" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Product </button>
				</div> <!-- /div-action -->				
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus" style="color: blue;"></i> Add Product</h4>
	      </div>
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="Product Name" maxlength="50" name="productName" autocomplete="off" id="text1" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;"
        onpaste="return false;" /><span id="error" style="color: Red; display: none">* Special Characters and Numbers not allowed</span>
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="quantity" placeholder="Quantity" name="quantity" autocomplete="off" onkeypress="return isNumber(event)" maxlength="10">
				    </div>
	        </div> <!-- /form-group-->	        	 
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate" placeholder="Price" name="rate" autocomplete="off" onkeypress="return isNumber(event)" maxlength="10">
				    </div>
	        </div> <!-- /form-group-->	     	        
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editProductName" placeholder="Product Name" name="editProductName" autocomplete="off" id="text1" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;"
        onpaste="return false;" /><span id="error" style="color: Red; display: none">* Special Characters and Numbers not allowed</span>
						    </div>
			        </div> <!-- /form-group-->	    
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editQuantity" placeholder="Quantity" name="editQuantity" autocomplete="off" onkeypress="return isNumber(event)" maxlength="10" />
						    </div>
			        </div> <!-- /form-group-->	        	 
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="number" class="form-control" id="editRate" placeholder="Price" name="editRate" autocomplete="off" onkeypress="return isNumber(event)" maxlength="10">
						    </div>
			        </div> <!-- /form-group-->	     	        
