...
<!--Footer-->
<footer style="height: 100px;" class="page-footer center-on-small-only unique-color-dark pt-0">


    <center><div style="background-color: white;width: auto;">
        <div class="container">
            <!--Grid row-->
            <div class="row py-4 d-flex align-items-center" >
                ...
                <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
                    <h6 class="mb-0 white-text" style="color: #6351CE;"><b>Follow us on social media</b></h6>
                </div>
                <!--Grid column-->
    ...
    <!--Footer Links-->
    <div class="container mt-5 mb-4 text-center text-md-left" style="background-color: #1C2331;width: auto; height:180px;">
        <div class="row mt-3" style="color: white;">

            <!--First column-->
            <div class="col-md-3 col-lg-4 col-xl-3 mb-r">
                <h6 class="title font-bold"><img style="color: width:60px;height: 60px;" src="warehouse.png"/></h6>
              
                <p>Goods Warehouse Management
                    </p>
            </div>
            <!--/.First column-->
    ...
    <!-- Copyright-->
    <div class="footer-copyright" style="background-color: #6351CE;height: 50px; width: auto;>
        <div class="container-fluid">
           <p> © 2018 by <strong>KMS General Merchandise</strong></p>
        </div></center>
